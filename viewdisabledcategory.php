...
include('session.php');
$sql="select * from category where status='9'";
                     ...
                     <!-- <li class="nav-item dropdown">
                       <a class="nav-link  dropdown-toggle" href="#" data-toggle="dropdown">HOME<span class="caret-drop"></span></a>
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li class="nav-item">
                        <a class="nav-link" href="addproduct_a.php">ADD PRODUCT</a>
                      </li> 
              ...
              <div class="col-lg-6">
                <div class="contact-box">
                  <div class="section-title">
                    <h2>View<span> Disabled Category</span></h2>
					...
					<tbody>
						...
						while($fetch=mysqli_fetch_array($exe))
						{
							...
							<td><?php echo $fetch['category_name']?></td>
                                    ...
                                    <td><a  style="padding:5px;width:25%;font-size:20px;font-family:cooper black;color:orange"  href="category_able.php?m=<?php echo $fetch['category_id'];?>"><font ><b>Enable</b></font></a></td>
