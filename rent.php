...
$ee="select * from addmachine where machine_name='$uid' ";
...
$sql5="INSERT INTO `agri3`.`rentpayment` (`id`,`reg_id`,`name`,`house_name`, `phone`,`machine_name`,`rate`,`mid`,`start_date`,`end_date`,`days`,`tprice`,`status` ) VALUES (NULL,'$user', '$a', '$b','$c','$d','$e','$me','$ee','$ff','$f','$g','unpaid');";
$exe5=mysqli_query($con,$sql5);
    ...
    header("location:rentpayment.php?".$query);
}
?>
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Machine Name</label>   
                                         <input id="machine_name" type="varchar" name="machine_name" value="<?php echo $fetch1['machine_name']?>"   class="form-control customize" required/>
                                        <p id="p2"></p>
                 <script>
       ...
       $('#p2').text("* please enter a valid name *");
        $("#machine_name").focus();
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Rate</label>
                                        <input id="rate" type="number"  value="<?php echo $fetch1['rate']?>" name="rate"  onKeyUp="multiply()"  class="form-control customize"  required/>
        ...
        $("#rate").focus();
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="mid" type="text"  value="<?php echo $fetch1['mid']?>" name="mid"   class="form-control customize"  required/>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="start_date" type="date" name="start_date"  class="form-control customize"  onblur="return checkDOB()" required/>
                                        <tr><td></td><td>
 <p id="p488"></p>
  <script type="text/javascript">
    function checkDOB() {
        ...
        if (myDate>today) { 
            ...
            $('#p488').show();
            $('#p488').text("* Invalid date. Choose another date *");
        $("#start_date").focus();
}
    }
</script>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>To Date</label>
                                        <input id="end_date" type="date" name="end_date" onblur="return checkDOB2()" class="form-control customize" required/>
                                        <tr><td></td><td>
 <p id="p996"></p>
  <script type="text/javascript">
    function checkDOB2() {
        ...
        if (date1<=date2) { 
            ...
            $('#p996').show();
            $('#p996').text("* Invalid date. Choose another date *");
        $("#end_date").focus();
}
    }
</script>
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Days</label>
                                        <input id="days" type="varchar" name="days"  onKeyUp="multiply()"  class="form-control customize" required/>
                                           <p id="p1"></p>
                 <script>
    ...
    if ( $(this).val() >= 1 && $(this).val() <= 1000 ) {
       ...
       $('#p1').text("* enter a valid value *");
        $("#days").focus();
                 ...
                 <script>
                     function multiply() {
  a = Number(document.getElementById('days').value);
