...
<body>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 space-break">
                <div class="contact-form">
                    <form  method="POST" action="dir_action.php" enctype="multipart/form-data">
 ...
 <p><select id="category1" type="dropdown"  class="form-control customize" name="category1" required>
                    <option value="">--Category--</option> 
                      <option value=" Agricultural Implements">Agricultural Implements</option>  
     <option value="Agriculture Colleges and Universities">Agriculture Colleges and Universities</option>  
          <option value="Agriculture Machinery">Agriculture Machinery</option>  

          <option value="Banks">Banks</option>  

          <option value="Bio Pesticide Companies">Bio Pesticide Companies</option>  

          <option value="Fertilizer Companies">Fertilizer Companies</option>  
       <option value="Irrigation Companies">Irrigation Companies</option>  
     <option value="Pump Companies">Pump Companies</option>  
      <option value="Pesticide Companies">Pesticide Companies</option>  
...
function validateImage() {
    ...
    return true;
                                    ...
                                    <div class="form-group">
                                        <label>Place</label>   
                                         <input id="place" type="varchar" name="place"  class="form-control customize" required/>
                                        <p id="p233"></p>
                 <script>
    ...
    if ( $(this).val().match('^[a-zA-Z  ]{3,30}$') ) {
       $('#p233').hide();
         ...
         $('#p233').show();
       $('#p233').text("* please enter a valid place *");
        $("#place").focus();
 ...
 <p><select id="district" type="dropdown"  class="form-control customize" name="district" required>
       ...
       $('#p8').text("*  Please enter valid email  *");
        $("#email").focus();
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Website</label>
                                        <input id="web" type="text" name="web" class="form-control customize"    required/>
                                        
                  <p id="p87"></p>
       <script>
                 $("#web").on("blur", function() {
    if ( $(this).val().match('^([a-zA-Z0-9_\.\-])+([a-zA-Z0-9]{2,4})+$') ) {
       $('#p87').hide();
    } else {
         $('#p87').show();
       $('#p87').text("*  Please enter valid website  *");
        $("#web").focus();
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p><input type="submit" class="btn btn-custom" name="submit" value="Add Directory"></p>
                                </div>
                            </div>
                        </div>
                    </form>  
