...
$sql1="update addmachine set machine_name='$b', des='$c',rate='$d' where mid='$uid'";
$exe1=mysqli_query($con,$sql1);
    header("location:addmachine.php");
}
$sql="select * from addmachine where mid='$uid'";
       ...
       <td><input type="text"  class="form-control" name="machine_name" value="<?php echo $new2['machine_name']?>"></td></tr>
         ...
         <tr> 
             <td> <label>Description</label></td><td><input type="text"  class="form-control" name="des" value="<?php echo $new2['des']?>"></td>
                            <tr><td> <label>Rate</label></td><td><input type="text"  class="form-control" name="rate" value="<?php echo $new2['rate']?>"></td></tr>
