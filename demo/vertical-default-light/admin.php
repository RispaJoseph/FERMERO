...
<body>
  <div class="container-scroller"> 
    ...
    <a class="navbar-brand brand-logo" href=""><img src="../../img/master/logo-2.png" alt="logo"/></a>
          <a class="navbar-brand brand-logo-mini" href=""><img src="../../img/master/logo-2.png" alt="logo"/></a>
         ...
         <!-- <li class="nav-item nav-profile dropdown">
          ...
          <li class="nav-item nav-profile dropdown">
            <div class="nav-link"  data-toggle="dropdown" id="profileDropdown">
              <span>Hi, <span class="nav-profile-name">Rispa</span></span>
              <span class="user-icon">R</span>
              </div>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown user-profile-action" aria-labelledby="profileDropdown">
              <div class="p-3 text-center bg-success">
                <img class="" src="../../images/person_3.jpg" alt="">
              </div>
          ...
          <li class="nav-item sidebar-profile mt-4">
            <a href="#">
              <div>
                ...
                <div class="mt-2">
                  <h3 class="mb-1 profile-name">Rispa</h3>
