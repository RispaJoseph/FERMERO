          ...
          <li class="nav-item nav-profile dropdown">
            <div class="nav-link"  data-toggle="dropdown" id="profileDropdown">
              ...
              <div class="p-3 text-center bg-success">
                <img class="img-avatar img-avatar48 img-avatar-thumb" src="../../../../images/person_3.jpg" alt="">
              </div>
						...
						while($fetch=mysqli_fetch_array($exe))
						{
                            ...
                            <tr>
                                ...
                                <td><?php echo $fetch['unitcost']?></td>
                                 <td><?php echo $fetch['months']?></td>
                                <td><?php echo $fetch['tprice']?></td>
                                <td><?php echo $fetch['magazine']?></td>
                                <td > <mark style="background-color:skyblue;width:35px;color:navyblue;"><?php echo $fetch['status']?></mark></td>
