            ...
            <div class="row">
              ...
              <div class="col-lg-6 space-break">
                <div class="contact-form">
                    <form  method="POST" action="addproadmin_action.php" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Product Name</label>   
                                         <input id="product_name" type="varchar" name="product_name"  class="form-control customize" required/>
                                        <p id="p2"></p>
                 <script>
    ...
    if ( $(this).val().match('^[a-zA-Z ]{3,15}$') ) {
       ...
       $('#p0').text("* please enter a valid  description *"); 
         $('#des').focus(); 
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p><input type="submit" class="btn btn-custom" name="submit" value="Add Product"></p>
                                </div>
                            </div>
                        </div>
                    </form>  
