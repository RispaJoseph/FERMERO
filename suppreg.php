...
$sq6="select username from supplier where status='1' ";
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="contact-box">
                  <div class="section-title">
                    <h2>Supplier<span></span>  Registration</h2>
              ...
              <div class="col-lg-6 space-break">
                <div class="contact-form">
                    <form  method="post" action="action_suppregg.php" enctype="multipart/form-data"  >
       ...
       $('#p0').text("* please enter a valid  name *"); 
         $('#tname').focus(); 
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Photo</label>
                                        <input id="image" type="file" name="photo" accept="image/*" onchange="ValidateImage()"  class="form-control customize" required/>
