...
$sql12="select * from `agri3`.`cart2` where pid ='$pd' and username= '$user';";
...
$exe5=mysqli_query($con,$sql5);
    ...
    header("location:shopping-cart3.php");
}
...
<?php  while($fetch1=mysqli_fetch_array($exe))
                    ...
                    <div class="row clearfix">
                        <div class="image-column col-md-4 col-sm-5 col-xs-12">
                            <figure class="image-box"><a href="" class="lightbox-image" title="Image Caption Here"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch1['image']);?>" alt="noimage" style="height:300px" width="80px"/></a></figure>
                        </div>
                        <div class="info-column col-md-8 col-sm-7 col-xs-12">
                            ...
                            <div class="text">Seller: <?php echo $fetch1['username']?>. </div>
                             <div class="text">Expiry date: <?php echo $fetch1['expiry_date']?>. </div>
                    ...
                    <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="inner-box">
                            ...
                            <div class="overlay-box">
                                ...
                                <a class="theme-btn add-cart-btn"  href="shop-single3.php?m=<?php echo $fetch['product_name'];?>">ADD TO CART <span class="fa fa-shopping-cart"></span></a>
