...
$uid=$_GET['m'];
$user=$_SESSION['sess'];
$sql="select * from lease where title!='$uid'  LIMIT 4";
...
$sql1="select * from lease where title='$uid' ";
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="info-column col-md-8 col-sm-7 col-xs-12">
                            <div class="details-header">
                                <h4 style="font-size:30px;">&nbsp;<?php echo $fetch1['service']?></h4>
                                
                                <div class="item-price"><span class="old-price"></span> <?php echo $fetch1['title']?></div>
                            </div>
                            <br>
  ...
  <span class="popuptext" id="myPopup">You can send your enquiry to us
      ...
      <input type="submit" name="sms" value="SMS "  style="width:100px;height:40px;" class="btn btn-danger"  >
        ...
        <section class="related-products">
        	<div class="auto-container">
                <div class="sec-title-one"><h2>Similar Lands</h2></div>
                    ...
                    <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <h3><a href="shop_singlelease.php"><?php echo $fetch['title']?></a></h3>
                            ...
                            <div class="overlay-box">
                                ...
                                <a class="theme-btn add-cart-btn"  href="shop_singlelease.php?m=<?php echo $fetch['title'];?>">Click to View <span class="fa fa-shopping-cart"></span></a>
