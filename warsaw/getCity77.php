...
$sql="select * from event where category1='$m'";
   ...
   <?php  while($fetch=mysqli_fetch_array($exe))
             {
                 ...
                 $ui=$fetch['category1'];
                 $fgh="select * from event where category1='$ui'";
                    ...
                    <div  class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="inner-box">
                            ...
                            <div class="overlay-box">
                                ...
                                <a class="theme-btn add-cart-btn"  href="event_single.php?m=<?php echo $fetch['title'];?>">VIEW MORE <span class="fa fa-shopping-cart"></span></a>
