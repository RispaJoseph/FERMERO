...
include('session.php');
$uid=$_GET['m'];
$sql="select * from addprosupp where product_name!='$uid'";
...
$sql2="update addprosupp  set status='9' where product_name='$uid'";
$exe2=mysqli_query($con,$sql2);
    header("location:supp_cart.php");
}
$sql1="select * from addprosupp where product_name='$uid'";
                                ...
                                <ul class="navigation clearfix">
                                  ...
                                  <li class="current dropdown"><a href="#">Machines</a>
                                    	<ul>
                                            ...
                                            <li><a href="../viewmachine.php">view machine</a></li>
                                            <li><a href="../rentmachine.php">Rent machine</a></li>
...
<?php  while($fetch1=mysqli_fetch_array($exe))
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="info-column col-md-8 col-sm-7 col-xs-12">
                            ...
                            <div class="availablity">Available:<?php echo $fetch1['amount']?>&nbsp;&nbsp;&nbsp;<?php echo $fetch1['quantity']?> Left in Stock</div>
