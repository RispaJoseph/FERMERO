...
$uid=$_GET['m'];
$user=$_SESSION['sess'];
$sql="select * from addproadmin where product_name!='$uid' and (category_name='PESTICIDES' or category_name='MACHINES' or category_name='SEEDS') LIMIT 4";
...
$sql12="select * from `agri3`.`cart1` where pid ='$pd' and username= '$user'";
$exe12=mysqli_query($con,$sql12);
if (mysqli_num_rows($exe12)==0)
{


$sql5="INSERT INTO `agri3`.`cart1` (`id`,`pid`,`username`, `status` ) VALUES (NULL, '$pd', '$user', '1');";
...
$sql12="select * from `agri3`.`wish1` where pid ='$pd' and username= '$user';";
$exe12=mysqli_query($con,$sql12);
if (mysqli_num_rows($exe12)==0)
{


$sql5="INSERT INTO `agri3`.`wish1` (`id`,`pid`,`username`, `status` ) VALUES (NULL, '$pd', '$user', '1');";
$exe5=mysqli_query($con,$sql5);
}
...
<?php  while($fetch1=mysqli_fetch_array($exe))
                    ...
                    <div class="row clearfix">
                        <div class="image-column col-md-4 col-sm-5 col-xs-12">
                            <figure class="image-box"><a href="" class="lightbox-image" title="Image Caption Here"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch1['image']);?>" alt="noimage" style="height:200px" width="100px"/></a></figure>
                        </div>
                    ...
                    <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="inner-box">
                            ...
                            <div class="overlay-box">
                                ...
                                <a class="theme-btn add-cart-btn"  href="shop-single1.php?m=<?php echo $fetch['product_name'];?>">ADD TO CART <span class="fa fa-shopping-cart"></span></a>
