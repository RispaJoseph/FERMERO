...
$sql="select * from addproduct where category_name='$m'";
...
<?php  while($fetch=mysqli_fetch_array($exe))
                ...
                <div class="row clearfix">
                    ...
                    <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="shop-single.html"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch['image']);?>" alt="noimage" height="100px" width="80px"/></a></figure>
                            </div>
