    ...
    <!--Shop Single-->
     ...
     ?>    
                ...
                <div   class="row clearfix">
                	...
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="http://localhost/project1/warsaw/shop-singlem.php"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch1['image']);?>" alt="noimage" style="height:300px" width="80px"/></a></figure>
                        </div>
                        <div class="lower-content">
                        	<h3><a href="shop_singlem.php"><?php echo $fetch1['magazine']?></a></h3>
                        ...
                        <div class="overlay-box">
                        	<div class="prod-options">
                                ...
                                <a class="theme-btn add-cart-btn"  href="shop_singlem.php?m=<?php echo $fetch1['magazine'];?>">CLICK TO VIEW </a>
