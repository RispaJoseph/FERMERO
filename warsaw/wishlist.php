...
//                       
                        $sql="select * from wish where username='".$user."'";
$exe=mysqli_query($con,$sql);
                ...
                <div id="s3" class="row clearfix">
                      ...
                      <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-9">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="shop-single3.php?=<?php echo $fetch['product_name'];?>"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch['image']);?>" alt="noimage" height="100px" width="80px"/></a></figure>
                        </div>
                        <div class="lower-content">
                        	<h3><a href="shop-single3.php?=<?php echo $fetch['product_name'];?>"></a></h3>
                        ...
                        <div class="overlay-box">
                        	<div class="prod-options">
                                ...
                                <a  class="theme-btn add-cart-btn" href="../remove_wishlist.php?b=<?php echo $fetch['pid'];?>">REMOVE </a>
