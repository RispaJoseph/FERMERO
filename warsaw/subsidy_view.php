...
$sql="select distinct title,image,des from subsidy where title='National Horticulture Mission' or title='National Agricultural Development Program' or title='National Bamboo Mission' LIMIT $offset, $no_of_records_per_page";
                       ...
                       <?php  while($fetch=mysqli_fetch_array($res))
                        ...
                        <div class="news-style-one">
                            <div class="inner-box" id="s3">
                                <figure class="image-box"><a href=""><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch['image']);?>" alt="noimage"   style="height:500px" width="200px"  /></a></figure>
                      
                                <div class="lower-content">
                                    <h3><a href="susidy_view.php"><?php echo $fetch['title']?>.</a></h3>
                                     <h4><a href="susidy_view.php"><?php echo $fetch['des']?>.</a></h4>
...
-->
           ...
           <div class="sidebar-side col-lg-3 col-md-4 col-sm-6 col-xs-12">
                    <aside class="sidebar">
                       ...
                       <div class="widget search-box sidebar-widget">
                            ...
                            <form method="post" action="subsidy_search.php">
                                <div class="form-group">
                                    <input type="text" name="title"  placeholder="Search a category">
  ...
  <p><select id="title" type="dropdown"  class="form-control customize" name="title" required  onChange="getCity39(this.value);">
                    <option value="">--Category--</option> 
                      <option value=" National Horticulture Mission"> National Horticulture Mission</option>  
     <option value="National Bamboo Mission">National Bamboo Mission</option> 
     <option value="National Agricultural Development Progarm">National Agricultural Development Progarm</option> 
		...
		$("#s3").html(data);
                       ...
                       <div class="widget recent-posts sidebar-widget">
                        ...
                        <div class="widget archives-list sidebar-widget">
                            ...
                            <ul class="list">
                                <li><a href="#">National Horticulture Mission</a></li>
                                <li><a href="#">National Bamboo Mission</a></li>
                                <li><a href="#">National Agricultural Development Program</a></li>
