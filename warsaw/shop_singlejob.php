...
$uid=$_GET['m'];
$user=$_SESSION['sess'];
$sql="select * from job where title!='$uid'  LIMIT 4";
...
if(isset($_POST['sms']))
{
    ...
    header("location:../sendsms1.php");
}
$sql1="select * from job where title='$uid' ";
...
.popup .popuptext::after {
  ...
  border-width: 5px;
  border-style: solid;
  border-color: browntransparent transparent transparent;
}
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="info-column col-md-8 col-sm-7 col-xs-12">
                            <div class="details-header">
                                <h4 style="font-size:30px;">&nbsp;<?php echo $fetch1['title']?></h4>
                                
                                <div class="item-price"><span class="old-price"></span>Salary: Rs <?php echo $fetch1['salary']?>(Monthly Payment)</div>
                            </div>
                            
                             
                             <div class="name">&nbsp;&nbsp;&nbsp;<b style="color:ash;">Farmer Name:</b> <?php echo $fetch1['name']?>.
                                                
                            </div> 
                            <br>
                            
                             <div class="date">&nbsp;&nbsp;&nbsp;<b>Location: </b><?php echo $fetch1['place']?>.
                                                
                            </div>
                            <br>
                            
                             <div class="location">&nbsp;&nbsp;&nbsp;<b>Date Added:</b> <?php echo $fetch1['date2']?>.
                                                
                            </div>
                            <br>
                             <div class="number">&nbsp;&nbsp;&nbsp;<b>Contact Number:</b> <?php echo $fetch1['phone']?>.
                                                
                            </div>
                            <br>
                            
                             <div class="text">&nbsp;&nbsp;&nbsp;<b>Description:</b> <?php echo $fetch1['des']?>.
                            ...
                            <div class="clearfix">
                               ...
                               <div class="popup" onclick="myFunction()" style="color:Green; font-size:20px;"><b>&nbsp;&nbsp;&nbsp;Contact Now</b>
  <span class="popuptext" id="myPopup">You can send your enquiry to us
      <br>
      <br>
      <br>
       <input type="submit" name="email" value="Email " class="btn btn-success"  style="width:100px;height:40px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input type="submit" name="sms" value="SMS "  style="width:100px;height:40px;" class="btn btn-danger"  >
                                   </span>
        ...
        <section class="related-products">
        	<div class="auto-container">
                <div class="sec-title-one"><h2>Our Jobs</h2></div>
...
<?php  while($fetch=mysqli_fetch_array($res))
                ...
                <div class="row clearfix">
                    ...
                    <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href=""><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch['image']);?>" alt="noimage" style="height:300px" width="80px"/></a></figure>
                            </div>
                            <div class="lower-content">
                                <h3><a href="shop_singlejob.php"><?php echo $fetch['title']?></a></h3>
                            ...
                            <div class="overlay-box">
                                ...
                                <a class="theme-btn add-cart-btn"  href="shop_singlejob.php?m=<?php echo $fetch['title'];?>">View <span class="fa fa-shopping-cart"></span></a>
