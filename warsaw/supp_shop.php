                            ...
                            <div class="navbar-collapse collapse clearfix">
                                <ul class="navigation clearfix">
                                   <li><a href="../home_farmer.php">home</a></li>
                                    ...
                                    <li class="current dropdown"><a href="#">MACHINES</a>
                                    	<ul>
                                            <li><a href="addmachine.php">ADD MACHINES</a></li>
                                           
                                            <li><a href="rentmachine.php">RENT MACHINES</a></li>
                                            <li><a href="viewmachine.php">VIEW MACHINES</a></li>
                                    ...
                                    <li class="current dropdown"><a href="#">Add</a>
                                    	<ul>
                                            ...
                                            <li><a href="supp_cart.php">Complaint</a></li>
                        ...
                        <div class="inner-box">
                            ...
                            <div class="overlay-box">
                                <div class="prod-options">
                                   ...
                                   <a class="option-btn"  href="supp_shop_single.php?m=<?php echo $fetch['pid'];?>"><span class="fa fa-heart-o"></span></a>
                                    <a class="option-btn"  href="supp_shop_single.php?m=<?php echo $fetch['pid'];?>"><span class="fa fa-retweet"></span></a>
                                <a class="theme-btn add-cart-btn"  href="supp_shop_single.php?m=<?php echo $fetch['pid'];?>">ADD TO CART <span class="fa fa-shopping-cart"></span></a>
