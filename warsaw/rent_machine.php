...
$sql="select * from addmachine where status='1'";
    ...
    <!--Shop Single-->
     ...
     ?>    
                ...
                <div   class="row clearfix">
                	...
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="http://localhost/project1/warsaw/shop_singlemachine.php"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch1['image']);?>" alt="noimage" style="height:300px" width="80px"/></a></figure>
                        </div>
                        <div class="lower-content">
                        	<h3><a href="shop_singlemachine.php"><?php echo $fetch1['machine_name']?></a></h3>
                        ...
                        <div class="overlay-box">
                        	<div class="prod-options">
                                ...
                                <a class="theme-btn add-cart-btn"  href="http://localhost/project9/warsaw/shop_singlemachine.php?m=<?php echo $fetch1['machine_name'];?>">CLICK TO VIEW </a>
