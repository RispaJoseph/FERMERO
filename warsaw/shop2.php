...
$sql="select * from addproduct where category_name='fruits' or category_name='vegetables'  and  expiry_date >= '$a'   LIMIT 4";
...
<div class="page-wrapper">
            	...
            	<div class="outer-container clearfix">
                    ...
                    <div class="nav-outer clearfix">
                        ...
                        <nav class="main-menu">
                            ...
                            <form action="search_prod_action1.php" method="POST">
 ...
 <p><select id="category_id" type="dropdown" class="form-control customize" onChange="getCity4(this.value);" name="category_name" required>
...
function getCity4(val) {
 ...
 <p><select id="pid" type="dropdown" class="form-control customize" onChange="getCity6(this.value);" name="product_name" required>
     ...
     <option value="Green peas">Green peas                
</option>
	...
	success: function(data){
     ...
     ?>
                ...
                <div id="s3" class="row clearfix">
                	...
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="shop-single3.php"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch['image']);?>" alt="noimage" height="100px" width="80px"/></a></figure>
                        </div>
                        ...
                        <div class="overlay-box">
                        	<div class="prod-options">
                                ...
                                <a class="theme-btn add-cart-btn"  href="shop-single3.php?m=<?php echo $fetch['product_name'];?>">CLICK TO VIEW </a>
    ...
    <footer class="main-footer footer-style-one">
    	...
    	<div class="footer-bottom">
            <div class="auto-container">
                ...
                <!--Copyright-->
                <div class="copyright">Copyrights &copy; Warsaw 2019. All rights reserved.</div>
