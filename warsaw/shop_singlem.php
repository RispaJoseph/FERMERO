...
$uid=$_GET['m'];
$user=$_SESSION['sess'];
$sql="select * from magazine where magazine!='$uid'  LIMIT 4";
...
$sql5="INSERT INTO `agri3`.`cart2` (`id`,`pid`,`username`, `status` ) VALUES (NULL, '$pd', '$user', '1');";
$exe5=mysqli_query($con,$sql5);
    header("location:../subscribe.php");
}
$sql1="select * from magazine where magazine='$uid' ";
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="info-column col-md-8 col-sm-7 col-xs-12">
                            <div class="details-header">
                                <h4><?php echo $fetch1['magazine']?></h4>
...
name="pp" value="<?php echo $fetch1['pid']; ?>">
                                <a class="theme-btn add-cart-btn"  href="../PaytmKit/index.php?b=<?php echo $fetch1['magazine'];?>">SUBSCRIBE </a>
        ...
        <section class="related-products">
        	<div class="auto-container">
                <div class="sec-title-one"><h2>Our Magazines</h2></div>
...
<?php  while($fetch=mysqli_fetch_array($res))
                ...
                <div class="row clearfix">
                    ...
                    <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="shop_singlem.html"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch['image']);?>" alt="noimage" style="height:300px" width="80px"/></a></figure>
                            </div>
                            <div class="lower-content">
                                <h3><a href="shop_singlem.php"><?php echo $fetch['magazine']?></a></h3>
                            ...
                            <div class="overlay-box">
                                ...
                                <a class="theme-btn add-cart-btn"  href="shop_singlem.php?m=<?php echo $fetch['magazine'];?>">Subscribe <span class="fa fa-shopping-cart"></span></a>
