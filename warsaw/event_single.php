...
$uid=$_GET['m'];
$user=$_SESSION['sess'];
$sql="select * from event where title!='$uid'  LIMIT 4";
...
$sql1="select * from event where title='$uid' ";
...
<?php  while($fetch1=mysqli_fetch_array($exe))
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="info-column col-md-8 col-sm-7 col-xs-12">
                            <div class="details-header">
                                <h4 style="font-size:30px;">&nbsp;&nbsp;&nbsp;<?php echo $fetch1['title']?>(<?php echo $fetch1['category1']?>)</h4>
                                
                                <div class="item-price"><span class="old-price"></span> &nbsp; <?php echo $fetch1['place']?>,<?php echo $fetch1['district']?></div>
                            </div>
                            
                             
                             <div class="name">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Date:</b> <?php echo $fetch1['date2']?>
      ...
      <a class="theme-btn add-cart-btn"  href="../ticket.php?m=<?php echo $fetch1['title'];?>"><h2 style="color:green;">Buy Tickets</h2> </a>
        ...
        <section class="related-products">
        	<div class="auto-container">
                <div class="sec-title-one"><h2>Similar Events</h2></div>
...
<?php  while($fetch=mysqli_fetch_array($res))
                ...
                <div class="row clearfix">
                    ...
                    <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><a href="event_single.php"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch['image']);?>" alt="noimage" style="height:300px" width="80px"/></a></figure>
                            </div>
                            <div class="lower-content">
                                <h3><a href="event_single.php"><?php echo $fetch['title']?></a></h3>
                            ...
                            <div class="overlay-box">
                                ...
                                <a class="theme-btn add-cart-btn"  href="event_single.php?m=<?php echo $fetch['title'];?>">View <span class="fa fa-shopping-cart"></span></a>
