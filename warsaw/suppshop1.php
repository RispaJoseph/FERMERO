...
$sql="select * from addprosupp where category_name='seeds' or category_name='pesticides' or category_name='machines'";
...
<div class="page-wrapper">
                            ...
                            <div class="navbar-collapse collapse clearfix">
                                    ...
                                    <li class="current dropdown"><a href="#">Purchase</a>
                                    	<ul>
                                            ...
                                            <li><a href="supp_cart.php">Shopping Cart</a></li>
                                             <li><a href="wishlist2.php">Wish List</a></li>
                                ...
                                <li class="current dropdown"><a href="#">View</a>
                                    ...
                                    <li><a href="../logout.php">Logout</a></li>
                                     <li>
                                    <a class="theme-btn add-cart-btn"  href="supp_cart.php"> <span class="fa fa-shopping-cart"></span></a></li>  <li>
                                        
                                        
                                        
                                        <div class="widget search-box sidebar-widget">
                            <form action="search_prod_action2.php" method="POST">
										
        <input  type="text" style="height:38px;"  onclick="getfocus()"  name="product_name" id="product_name" placeholder="Search a product.." required>
                                    <button style="color:ash;width:25px;height:38px; background-color:rgb(124,194,152);;display: inline-block;" type="submit" name="search" id="search" value="" ><span class="icon fa fa-search"></span></button>
 ...
 <p><select id="category_id" type="dropdown" class="form-control customize" onChange="getCity44(this.value);" name="category_name" required>
     <option value="">Category</option>
                        <?php
    while($fetch1=mysqli_fetch_array($me2))
						{
                            ?>
               <option value="<?php echo $fetch1['category_name']?>"><?php echo $fetch1['category_name']?>  <?php
                        }
?></option>
	...
	success: function(data){
     ...
     ?>
                ...
                <div id="s3" class="row clearfix">
                	...
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="shop-single.php"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch['image']);?>" alt="noimage" style="height:300px" width="80px"/></a></figure>
                        </div>
                        ...
                        <div class="overlay-box">
                        	<div class="prod-options">
                                ...
                                <a class="theme-btn add-cart-btn"  href="shop-single1.php?m=<?php echo $fetch['product_name'];?>">CLICK TO VIEW </a>
                ...
                <div id="s3" class="row clearfix">
                    ...
                    <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div  class="inner-box">
                            <div  class="image-box">
                                <figure class="image"><a href="shop-single.html"> </a></figure>
                            </div>
                            <div class="lower-content">
                                <h3><a href="shop-single.html"></a></h3>
                                <div class="price"><span class="price-txt"></span></div>
                            </div>
                            ...
                            <div class="overlay-box">
                                <div class="prod-options">
                                    ...
                                    <a class="option-btn" href="shop-single1.php"><span class="fa fa-heart-o"></span></a>
                                    <a class="option-btn" href="shop-single1.php"><span class="fa fa-retweet"></span></a>
                                    
                                <a class="theme-btn add-cart-btn"  href="shop-single1.php">ADD TO CART <span class="fa fa-shopping-cart"></span></a>
               ...
               <!-- <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="shop-single.html"><img src="images/resource/products/image-1.jpg" alt=""></a></figure>
                        </div>
                        <div class="lower-content">
                        	<h3><a href="shop-single.html">Passion Fruits</a></h3>
                            <div class="price"><span class="price-txt">$ 25.00</span></div>
                        </div>
                       ...
                       <!-- <div class="overlay-box">
                        	<div class="prod-options">
                                ...
                                <a class="option-btn" href=""><span class="fa fa-heart-o"></span></a>
                                <a class="option-btn" href=""><span class="fa fa-retweet"></span></a>
                                <a href="" class="theme-btn add-cart-btn">ADD TO CART <span class="fa fa-shopping-cart"></span></a>
                            </div>
                        </div>
             ...
             <!--   <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="shop-single.html"><img src="images/resource/products/image-2.jpg" alt=""></a></figure>
                        </div>
                        <div class="lower-content">
                        	<h3><a href="shop-single.html">Kiwi Fruits</a></h3>
                            <div class="price"><span class="price-txt">$ 22.00</span></div>
                        </div>
                        
                        <!--Overlay Box-->
                       <!-- <div class="overlay-box">
                        	<div class="prod-options">
                            	<a class="lightbox-image option-btn" href="images/resource/products/image-2.jpg" title="Image Caption Here" data-fancybox-group="example-gallery"><span class="fa fa-eye"></span></a>
                                <a class="option-btn" href=""><span class="fa fa-heart-o"></span></a>
                                <a class="option-btn" href=""><span class="fa fa-retweet"></span></a>
                                <a href="" class="theme-btn add-cart-btn">ADD TO CART <span class="fa fa-shopping-cart"></span></a>
                            </div>
               ...
               <!-- <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="shop-single.html"><img src="images/resource/products/image-3.jpg" alt=""></a></figure>
                        </div>
                        <div class="lower-content">
                        	<h3><a href="shop-single.html">Orange Fruits</a></h3>
                            <div class="price"><span class="price-txt">$ 18.00</span></div>
                        </div>
                        
                        <!--Overlay Box-->
                      <!--  <div class="overlay-box">
                        	<div class="prod-options">
                            	<a class="lightbox-image option-btn" href="images/resource/products/image-3.jpg" title="Image Caption Here" data-fancybox-group="example-gallery"><span class="fa fa-eye"></span></a>
                                <a class="option-btn" href=""><span class="fa fa-heart-o"></span></a>
                                <a class="option-btn" href=""><span class="fa fa-retweet"></span></a>
                                <a href="" class="theme-btn add-cart-btn">ADD TO CART <span class="fa fa-shopping-cart"></span></a>
                            </div>
                ...
                <!--<div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="shop-single.html"><img src="images/resource/products/image-4.jpg" alt=""></a></figure>
                        </div>
                        <div class="lower-content">
                        	<h3><a href="shop-single.html">Pepper</a></h3>
                            <div class="price"><span class="price-txt">$ 14.00</span></div>
                        </div>
                        
                        <!--Overlay Box-->
                       <!-- <div class="overlay-box">
                        	<div class="prod-options">
                            	<a class="lightbox-image option-btn" href="images/resource/products/image-4.jpg" title="Image Caption Here" data-fancybox-group="example-gallery"><span class="fa fa-eye"></span></a>
                                <a class="option-btn" href=""><span class="fa fa-heart-o"></span></a>
                                <a class="option-btn" href=""><span class="fa fa-retweet"></span></a>
                                <a href="" class="theme-btn add-cart-btn">ADD TO CART <span class="fa fa-shopping-cart"></span></a>
                            </div>
                ...
                <!--<div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="shop-single.html"><img src="images/resource/products/image-5.jpg" alt=""></a></figure>
                        </div>
                        <div class="lower-content">
                        	<h3><a href="shop-single.html">Tomatoes</a></h3>
                            <div class="price"><span class="price-txt">$ 30.00</span></div>
                        </div>
                        
                        <!--Overlay Box-->
                       <!-- <div class="overlay-box">
                        	<div class="prod-options">
                            	<a class="lightbox-image option-btn" href="images/resource/products/image-5.jpg" title="Image Caption Here" data-fancybox-group="example-gallery"><span class="fa fa-eye"></span></a>
                                <a class="option-btn" href=""><span class="fa fa-heart-o"></span></a>
                                <a class="option-btn" href=""><span class="fa fa-retweet"></span></a>
                                <a href="" class="theme-btn add-cart-btn">ADD TO CART <span class="fa fa-shopping-cart"></span></a>
                            </div>
              ...
              <!--  <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="shop-single.html"><img src="images/resource/products/image-6.jpg" alt=""></a></figure>
                        </div>
                        <div class="lower-content">
                        	<h3><a href="shop-single.html">Ripe Pea</a></h3>
                            <div class="price"><span class="price-txt">$ 13.00</span></div>
                        </div>
                        
                        <!--Overlay Box-->
                       <!-- <div class="overlay-box">
                        	<div class="prod-options">
                            	<a class="lightbox-image option-btn" href="images/resource/products/image-6.jpg" title="Image Caption Here" data-fancybox-group="example-gallery"><span class="fa fa-eye"></span></a>
                                <a class="option-btn" href=""><span class="fa fa-heart-o"></span></a>
                                <a class="option-btn" href=""><span class="fa fa-retweet"></span></a>
                                <a href="" class="theme-btn add-cart-btn">ADD TO CART <span class="fa fa-shopping-cart"></span></a>
                            </div>
              ...
              <!--  <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="shop-single.html"><img src="images/resource/products/image-7.jpg" alt=""></a></figure>
                        </div>
                        <div class="lower-content">
                        	<h3><a href="shop-single.html">Figs Sweet</a></h3>
                            <div class="price"><span class="price-txt">$ 32.00</span></div>
                        </div>
                        
                        <!--Overlay Box-->
                      <!--  <div class="overlay-box">
                        	<div class="prod-options">
                            	<a class="lightbox-image option-btn" href="images/resource/products/image-7.jpg" title="Image Caption Here" data-fancybox-group="example-gallery"><span class="fa fa-eye"></span></a>
                                <a class="option-btn" href=""><span class="fa fa-heart-o"></span></a>
                                <a class="option-btn" href=""><span class="fa fa-retweet"></span></a>
                                <a href="" class="theme-btn add-cart-btn">ADD TO CART <span class="fa fa-shopping-cart"></span></a>
                            </div>
             ...
             <!--   <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="shop-single.html"><img src="images/resource/products/image-8.jpg" alt=""></a></figure>
                        </div>
                        <div class="lower-content">
                        	<h3><a href="shop-single.html">Carrot Fruits</a></h3>
                            <div class="price"><span class="price-txt">$ 22.00</span></div>
                        </div>
                      ...
                      <!--  <div class="overlay-box">
                        	<div class="prod-options">
                            	<a class="lightbox-image option-btn" href="images/resource/products/image-8.jpg" title="Image Caption Here" data-fancybox-group="example-gallery"><span class="fa fa-eye"></span></a>
                                <a class="option-btn" href=""><span class="fa fa-heart-o"></span></a>
                                <a class="option-btn" href=""><span class="fa fa-retweet"></span></a>
                                <a href="" class="theme-btn add-cart-btn">ADD TO CART <span class="fa fa-shopping-cart"></span></a>
                            </div>
