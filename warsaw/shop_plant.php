...
$sql="select * from plant where category_name='Grow Bags' or Category_name='Vermi Beds' order by unitcost asc  LIMIT 4";
...
<div class="page-wrapper">
 ...
 <p><select id="category_name" type="dropdown"  class="form-control customize" name="category_name" onChange="getCity5(this.value);"  required>
	...
	success: function(data){
     ...
     ?>    
                ...
                <div id="s3"   class="row clearfix">
                	...
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="http://localhost/project1/warsaw/shop-singleplant.php"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch1['image']);?>" alt="noimage" style="height:300px" width="80px"/></a></figure>
                        </div>
                        <div class="lower-content">
                        	<h3><a href=""><?php echo $fetch1['title']?></a></h3>
                        ...
                        <div class="overlay-box">
                        	<div class="prod-options">
                                ...
                                <a class="theme-btn add-cart-btn"  href="shop_singleplant.php?m=<?php echo $fetch1['title'];?>">CLICK TO VIEW </a>
