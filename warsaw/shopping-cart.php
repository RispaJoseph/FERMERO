                            ...
                            <tr>
                                ...
                                <td colspan="2" class="prod-column">
                                 ...
                                 <form method="POST">
                                    ...
                                    <?php 
                                        echo"<td class='price'><input type='number' name='unitcost' id='unitcost' onblur='multiply()'   value='".$fetch['unitcost'].".00' class='prod_qty' /></td>";
                                
                               
                                
                                        echo"<td ><input type='number' name='quantity'  onKeyUp='multiply()'  id='quantity' value='0' class='prod_qty' /></td>";


                                        echo"<td class='price'><input type='number' id='tprice' name='tprice' class='price' />"
                                        ."<p id='p10'></p>";
                                                        ?>
                 <script>
//                      function multiply() {
