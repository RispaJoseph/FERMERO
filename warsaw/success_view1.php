...
$sql="select * from success order by date desc, time desc";
            ...
            <div class="row clearfix">
                ...
                <div class="content-side col-lg-9 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <div class="styled-pagination text-left">
                        <ul>
                            <li><a href="success_view.php" class="active">1</a></li>
                            <li><a href="success_view1.php">2</a></li>
                            <li><a href="success_view3.php">3</a></li>
                            <li><a class="next" href="success_view4.php">Next</a></li>
                        </ul>
                    </div>
