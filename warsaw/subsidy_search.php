...
$m=$_POST['title'];
//$view="select * from subsidy where  title LIKE '%$m%'  ";
    $view="select distinct title,image,des from subsidy where title LIKE '%$m%' ";
...

{
	...
	window.location='subsidy_view.php';
	</script>";
...
<p><select id="title" type="dropdown"  class="form-control customize" name="title" onChange="getCity39(this.value);"  required>
