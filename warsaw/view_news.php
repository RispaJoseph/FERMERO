                        ...
                        <nav class="main-menu">
                            ...
                            <div class="navbar-collapse collapse clearfix">
                                <ul class="navigation clearfix">
                                   <li><a href="../demo/vertical-default-light/admin.php">home</a></li>
                                    
                                   
                                   
                                    <li class="current dropdown"><a href="#">Category</a>
                                    	<ul>
                                      ...
                                      <li class="current dropdown"><a href="#">Products</a>
                                    	<ul>
                                            <li><a href="../addproduct_a.php">Add Products</a></li>
                                           
                                            <li><a href="../view_adminproducts_a.php">View Products</a></li>
                                            
                                        </ul>
                                    </li>
                                      <li class="current dropdown"><a href="#">View Users</a>
                                    	<ul>
                                            <li><a href="../farmview.php">Farmer</a></li>
                                           
                                            <li><a href="../suppview.php">Supplier</a></li>
                                            <li><a href="../userview.php">User</a></li>
    	...
    	<div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="shop-single.html"><img src="images/resource/products/news2.png"  height="200px" width="160px"></a></figure>
                        </div>
                        
                        
                        <!--Overlay Box-->
                        <div class="overlay-box">
                        	<a class="theme-btn add-cart-btn"  href="https://timesofindia.indiatimes.com/home/education/news/agriculture-varsity-adopts-500-farmers-to-increase-their-financial-health/articleshow/73665887.cms">CLICK TO VIEW </a>
                ...
                <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="shop-single.html"><img src="images/resource/products/news1.PNG" alt=""></a></figure>
                        </div>
                        
                        
                        <!--Overlay Box-->
                        <div class="overlay-box">
                        	<a class="theme-btn add-cart-btn"  href="https://timesofindia.indiatimes.com/home/education/news/himachal-agri-varsity-proposes-new-vegetable-varieties-at-national-level/articleshow/73701451.cms">CLICK TO VIEW </a>
