...
$sql1="select * from dir where title='$uid'";
                    ...
                    <section class="blog-classic-view post-details">
                       <?php  while($fetch=mysqli_fetch_array($res))
                        ...
                        <div class="news-style-one">
                            <div class="inner-box">
                                <figure class="image-box"><a href="shop_directory.php"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch['image']);?>" alt="noimage" style="height:400px" width="200px" /></a></figure>
                                 
                                <div class="lower-content">
                                    <h3><a style="font-size:25px;" href="shop_directory.php"><?php echo $fetch['title']?>.</a></h3>
                                    <br>
                                    <div class="post-content">
                                    	<div class="text">
                                            <p><b style="font-size:16px;"> Deals with : </b><?php echo $fetch['des']?></p>
                                        </div>
                                        <div class="text">
                                            <p><b style="font-size:16px;">Phone Number : </b><?php echo $fetch['phone']?></p>
                                        </div>
                                        <div class="text">
                                            <p><b style="font-size:16px;">Email : </b><?php echo $fetch['email']?></p>
                                        </div>
                                        <div class="text">
                                            <p><b style="font-size:16px;">Website : </b><?php echo $fetch['web']?></p>
                                        </div>
