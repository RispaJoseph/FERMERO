...
$uid=$_GET['m'];
$user=$_SESSION['sess'];
$sql="select * from addmachine where machine_name!='$uid'  LIMIT 4";
...
$sql1="select * from addmachine where machine_name='$uid' ";
                        ...
                        <nav class="main-menu">
                            ...
                            <div class="navbar-collapse collapse clearfix">
                                ...
                                <li class="current dropdown"><a href="#">View</a>
                                    	<ul>
                                            <li><a href="../event-landing/event/event.php">Events</a></li>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="info-column col-md-8 col-sm-7 col-xs-12">
                            <div class="details-header">
                                <h4><?php echo $fetch1['machine_name']?></h4>
                                ...
                                <div class="item-price"><span class="old-price">$128</span> $<?php echo $fetch1['rate']?>.00</div>
                            </div>
                            
                                                     
                                                  
                             <div class="text">Seller: <?php echo $fetch1['name']?>. </div>
                                                  
                             <div class="phone">Contact Number: <?php echo $fetch1['phone']?>. </div>
  ...
  <span class="popuptext" id="myPopup">You can send your enquiry to us
      ...
      <input type="submit" name="sms" value="SMS "  style="width:100px;height:40px;" class="btn btn-danger"  >
       ...
       <section class="related-products">
        	<div class="auto-container">
                <div class="sec-title-one"><h2>Our Machines</h2></div>
                    ...
                    <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <h3><a href=""><?php echo $fetch['machine_name']?></a></h3>
                            ...
                            <div class="overlay-box">
                                ...
                                <a class="theme-btn add-cart-btn"  href="shop_singlemachine.php?m=<?php echo $fetch['machine_name'];?>">View <span class="fa fa-shopping-cart"></span></a>
