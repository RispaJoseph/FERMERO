...
$sql1="select * from success where nid='$uid'";
$res=mysqli_query($con,$sql1);
$sql="select * from success where title!='$uid' LIMIT 3";
                    ...
                    <section class="blog-classic-view post-details">
                       <?php  while($fetch=mysqli_fetch_array($res))
                        ...
                        <div class="news-style-one">
                            <div class="inner-box">
                                <figure class="image-box"><a href="blog-single.html"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch['image']);?>" alt="noimage" style="height:400px" width="300px" /></a></figure>
                                 
                                <div class="lower-content">
                                    <h3><a href="success_single.php"><?php echo $fetch['title']?>.</a></h3>
        	...
        	<div class="row clearfix">
                ...
                <div class="news-style-one col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <div class="lower-content">
                        	<h3><a href="success_single.php?m=<?php echo $fetch['nid'];?>"><?php echo $fetch['title']?>.</a></h3>
                            ...
                            <div class="info clearfix">
                                ...
                                <div class="more-link"><a href="success_single.php?m=<?php echo $fetch['nid'];?>">Read More</a></div>
                            </div>
                        </div>
                    </div>
                </div>
