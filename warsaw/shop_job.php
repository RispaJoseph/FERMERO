...
<div class="page-wrapper">
 ...
 <p><select id="category1" type="dropdown"  class="form-control customize" name="category1" onChange="getCity8(this.value);"  required>
	...
	success: function(data){
     ...
     ?>    
                ...
                <div  id="s3"  class="row clearfix">
                	...
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="http://localhost/project1/warsaw/shop-singlejob.php"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch1['image']);?>" alt="noimage" style="height:300px" width="80px"/></a></figure>
                        </div>
                        ...
                        <div class="overlay-box">
                        	<div class="prod-options">
                                ...
                                <a class="theme-btn add-cart-btn"  href="shop_singlejob.php?m=<?php echo $fetch1['title'];?>">CLICK TO VIEW </a>
