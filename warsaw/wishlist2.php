...
//                       
                        $sql="select * from wish1 where username='".$user."'";
$exe=mysqli_query($con,$sql);
                        ...
                        while($fetch1=mysqli_fetch_array($exe)){
                            ...
                            $sql1="select * from addprosupp  where pid=".$fetch1['pid'];
                	...
                	<div class="inner-box">
                        ...
                        <div class="overlay-box">
                        	<div class="prod-options">
                                ...
                                <a  class="theme-btn add-cart-btn" href="../remove_wishlist2.php?b=<?php echo $fetch['pid'];?>">REMOVE </a>
