...
$sql1="select * from addnews where title='$uid'";
$res=mysqli_query($con,$sql1);
$sql="select * from addnews where title!='$uid' LIMIT 3";
                       ...
                       <?php  while($fetch=mysqli_fetch_array($res))
                        ...
                        <div class="news-style-one">
                            <div class="inner-box" id="s3">
                                <figure class="image-box"><a href="blog-single.php"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch['image']);?>" alt="noimage" style="height:400px" width="300px" /></a></figure>
        	...
        	<div class="row clearfix">
                ...
                <div class="news-style-one col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                        ...
                        <div class="lower-content">
                        	<h3><a href="blog-single.php?m=<?php echo $fetch['title'];?>"><?php echo $fetch['title']?>.</a></h3>
