...
$sql="select distinct title,image from dir where title='Agricultural Implements' or title='Agriculture Colleges and Universities' or title='Agriculture Machinery' or title='Banks' or title='Bio Pesticide Companies' or title='Fertilizer Companies' or title='Irrigation Companies' or title='Pump Companies' or title='Pesticide Companies' or title='Nurseries'";
//$sql="select * from dir";
...
<div class="page-wrapper">
 ...
 <p><select id="category_id" type="dropdown" class="form-control customize" onChange="getCity444(this.value);" name="category_name" required>
	...
	success: function(data){
     ...
     ?>
                ...
                <div id="s3" class="row clearfix">
                	...
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="shop_directory.php"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch['image']);?>" alt="noimage" height="100px" width="80px"/></a></figure>
                        </div>
                        <div class="lower-content">
                        	<h3><a href="shop_directory.php"><?php echo $fetch['title']?></a></h3>
                        ...
                        <div class="overlay-box">
                        	<div class="prod-options">
                                ...
                                <a class="theme-btn add-cart-btn"  href="shop_directory.php?m=<?php echo $fetch['title'];?>">CLICK TO VIEW </a>
                ...
                <div class="default-shop-item col-lg-3 col-md-4 col-sm-6 col-xs-12">
                	<div class="inner-box">
                    	<div class="image-box">
                        	<figure class="image"><a href="shop-single.php"><img src="images/resource/products/image-1.jpg" alt=""></a></figure>
                        </div>
                        <div class="lower-content">
