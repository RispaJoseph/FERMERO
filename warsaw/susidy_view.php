...
$sql="select * from subsidy order by date percentage LIMIT $offset, $no_of_records_per_page";
                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="info clearfix">
                                        ...
                                        <div class="more-link"><a href="subsidy_single.php?m=<?php echo $fetch['nid'];?>">Read More</a></div>
