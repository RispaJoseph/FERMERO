...
<div class="page-wrapper">
 ...
 <p><select id="category1" type="dropdown"  class="form-control customize" name="category1" onChange="getCity77(this.value);"  required>
                    <option value="">--Category--</option> 
    <option value=" Conference">Conference</option>  
     <option value="Exhibition">Exhibition</option>  
    <option value="Karshika Mela">Karshika Mela</option>
                	...
                	<div class="inner-box">
                        ...
                        <div class="overlay-box">
                        	<div class="prod-options">
                                ...
                                <a class="theme-btn add-cart-btn"  href="event_single.php?m=<?php echo $fetch1['title'];?>">CLICK TO VIEW </a>
