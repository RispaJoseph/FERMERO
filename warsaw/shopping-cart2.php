...
{
    $count=$_POST['dataUpdate'];
    for($i=1;$i<$count+1;$i++){
        $a=$_POST['product_name'.$i];
        $aa=$_POST['pid'.$i];
        $e=date("y/m/d");
     $f=date("h:i:sa",time());
        $b=$_POST['unitcost'.$i];
        $c=$_POST[''.$i];
        $d=$_POST['tprice'.$i];
        $sql5="INSERT INTO `agri3`.`payment1` (`id`,`product_name`,`pid`,`unitcost`,`quantity`,`tprice`,`username`,`date`,`time` ) VALUES (NULL, '$a','$aa', '$b','$c','$d','$user','$e','$f');";
            ...
            <div class="cart-outer">
                <div class="table-outer">
                   ...
                   <?php
                        ...
                        $c=0;
//                       
                        $sql="select * from cart3 where username='".$user."'";
                            ...
                            <tr>
                                <td colspan="2" class="prod-column">
                                    <div class="column-box">
                                        ...
                                        <?php echo"<input type='text' name='product_name$c' id='product_name$c' value='".$fetch['product_name']."' style='display:none'/>"; ?>
...
<!--                                <form method="post">-->
                                    ...
                                    ?>
<!--                                </form>-->
                                <td><a href="remove_cart2.php?b=<?php echo $fetch['pid'];?>">
...
<!--                            <input type="submit"  name="submit" value="Buy Now" class="theme-btn btn-style-one">-->
                            <button type="submit" class="theme-btn btn-style-one" id="dataUpdate" name="dataUpdate" value='<?php echo $c;?>'>Buy Now</button>
                        </div>
                        </form>
