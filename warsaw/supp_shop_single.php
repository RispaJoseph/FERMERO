...
$sql2="update addprosupp  set status='9' where pid='$uid'";
$exe2=mysqli_query($con,$sql2);
    header("location:supp_cart.php");
}
$sql1="select * from addprosupp where pid='$uid'";
$exe=mysqli_query($con,$sql1);
$sql2="select * from addprosupp where status='9'";
$exe3=mysqli_query($con,$sql2);
?>
...
<div class="page-wrapper">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a class="dropdown-item" href="viewmachine.php">VIEW MACHINES</a></li>
                                    ...
                                    <li class="current dropdown"><a href="#">PURCHASE</a>
                                    	<ul>
                                            <li><a href="supp_shop.php">Our Shop</a></li>
                                    ...
                                    <li><a href="../logout.php">Logout</a></li>
                                     <li>
                                    <a class="theme-btn add-cart-btn"  href=""> <span class="fa fa-shopping-cart"></span></a>
                                          <ul class="dropdown-menu">
							<li>
								<table class="table">
									<tbody>
                                        <?php  while($fetch3=mysqli_fetch_array($exe3))
                                                    {
                                                ?> 
										<tr>
											<td class="text-center">
												<img src="data:image/jpeg;base64,<?php echo base64_encode($fetch3['image']);?>"alt="noimage" height="50px" width="80px"/>
                                                
											</td>
											<td class="text-left">
												<a href="#"><?php echo $fetch3['product_name']?></a>
												<p><?php echo $fetch3['quantity']?> x $ <?php echo $fetch3['unitcost']?></p>
											</td>
											<td class="text-center">
								...
								<div class="buttons">
									<button class="btn-primary" type="button" onclick="location.href=''"><i class="icon_cart"></i> View Cart</button>
									<button class="btn-primary" type="button" onclick="location.href=''"><i class="icon_box-checked"></i> Checkout</button>
								</div>
							</li>
						</ul>
                                   </li>
    ...
    <!--Page Title-->
    <section class="page-title" style="background-image:url(images/img7.jpg);">
        <div class="auto-container">
...
<?php  while($fetch1=mysqli_fetch_array($exe))
                    ...
                    <div class="row clearfix">
                        <div class="image-column col-md-4 col-sm-5 col-xs-12">
                            <figure class="image-box"><a href="images/resource/products/image-13.jpg" class="lightbox-image" title="Image Caption Here"><img src="data:image/jpeg;base64,<?php echo base64_encode($fetch1['image']);?>" alt="noimage" height="100px" width="80px"/></a></figure>
                        </div>
                        <div class="info-column col-md-8 col-sm-7 col-xs-12">
                            ...
                            <div class="text"><?php echo $fetch1['des']?>. </div>
                            <div class="availablity">Available:<?php echo $fetch1['quantity']?> Left in Stock</div>
                        ...
                        <div class="inner-box">
                            ...
                            <div class="overlay-box">
                                <div class="prod-options">
                                    ...
                                    <a class="option-btn"  href="shop-single.php?m=<?php echo $fetch['pid'];?>"><span class="fa fa-heart-o"></span></a>
                                    <a class="option-btn"  href="shop-single.php?m=<?php echo $fetch['pid'];?>"><span class="fa fa-retweet"></span></a>
                                     
                                <a class="theme-btn add-cart-btn"  href="shop-single.php?m=<?php echo $fetch['pid'];?>">ADD TO CART <span class="fa fa-shopping-cart"></span></a>
