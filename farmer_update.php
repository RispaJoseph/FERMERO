...
$sql="select * from reg where username='$user' and status='0'";
...
while($row=mysqli_fetch_array($res))
	...
	$phone=$row['phone'];
        ...
        $username=$row['username'];
				...
				document.update.getElementById('fname').innerHTML='$name';
				document.getElementById('age').innerHTML='$age';
				document.getElementById('house_name').innerHTML='$house_name';
            ...
            <div class="row">
              ...
              <div class="col-lg-6 space-break">
                <div class="contact-form">
                    <form  method="post" action="farmer_update_profile.php" >
