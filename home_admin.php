    ...
    <div class="main-slider">
       <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('img/images/media-thumb4.jpg')">
          ...
          <div class="carousel-item" style="background-image: url('img/images/CORN.jpg')">
            <div class="carousel-caption">
          ...
          <div class="carousel-item" style="background-image: url('img/images/product4.jpg')">
            <div class="carousel-caption">
