...
$sql1="update rent set status='9' where rid='$uid'";
$exe1=mysqli_query($con,$sql1);
    header("location:viewdisabledrentmachine.php");
}
$sql="select * from rent where rid='$uid'";
              ...
              <div class="col-lg-6">
                <div class="contact-box">
                  <div class="section-title">
                    <h2>Disable<span> Rent Machines</span></h2>
...
<center><h1 style="color:rgb(181,230,29);"><i><b> </b></i></h1></center>
       ...
       <td><input type="text"  class="form-control" name="machine_name" value="<?php echo $new2['machine_name']?>"></td></tr>
                            
         <tr> 
             <td> <label>From Date</label></td><td><input type="text"  class="form-control" name="date2" value="<?php echo $new2['date2']?>"></td>
                            <tr><td> <label>To Date</label></td><td><input type="text"  class="form-control" name="to" value="<?php echo $new2['to']?>"></td></tr>
                            
                            
                            <tr><td> <label>Total Rent</label></td><td><input type="text"  class="form-control" name="total_rent" value="<?php echo $new2['total_rent']?>"></td></tr>
							...
							<th></th>
		<td><input type="submit" name="submit"  class="btn btn-custom" value="Disable"></td></tr>
