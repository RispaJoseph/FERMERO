...
if(isset($_POST['submit'])){
    ...
    $anu="select * from ticket where reg_id='$pd' and title='$mg'";
 ...
 $ch11=mysqli_query($con,"select * from bank_info where name='ADMIN'");
    ...
    $qw3=mysqli_query($con,"update bank_info set balance='$credit' where name='ADMIN'");
     ...
     $qw5=mysqli_query($con,"update ticket set status='paid' where id='$id'");
        }else{ ?>
   ...
   <?php }
    ...
    $to = "archanakartha16@gmail.com";
        ...
        $message = "Dear Customer, \n you had successfully booked your tickets for the event .\n  Thanks and Regards,\nAgrom Team";
        $headers = "From:".$from;     
