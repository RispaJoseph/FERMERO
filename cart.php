...
if(isset($_POST['submit']))
{
          ...
          echo "<script>";echo "alert('Thankyou for Purchasing!!Your Order was Placed Successfully')";echo"</script>";
        header("location:./Receipt/bill.php");
            ...
            <div class="row">
              ...
              <div class="col-lg-6 space-break">
                <div class="contact-form">
                    <form  method="post" action="http://localhost/project1/Receipt/bill.php" target="_blank" >
