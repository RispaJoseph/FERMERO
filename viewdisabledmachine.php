...
$sq3="select * from addmachine where status='9'";
              ...
              <div class="col-lg-6">
                <div class="contact-box">
                  <div class="section-title">
                    <h2>View<span>  Disabled Machines</span></h2>
						...
						while($fetch=mysqli_fetch_array($exe))
						{
							?>
						        <tr>
                                    ...
                                    <td><a  style="padding:5px;width:25%;font-size:20px;font-family:cooper black;color:orange" href="machine_enable.php?m=<?php echo $fetch['mid'];?>"><font ><b>Enable</b></font></a></td>                                  
