    ...
    <table class="table table-striped" align="center">
                    <thead>
                      ...
                      <th style="font-size:20px;color:darkorange"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NAME</b></th>
                            <th style="font-size:15px;color:orange"><a href="./pdf/userdown.php" class="btn btn-custom">&nbsp;&nbsp;&nbsp;DOWNLOAD<span  class="glyphicon glyphicon-download-alt"></span></a></th>
						...
						{
							?>
                    <td style="font-size:27px;" align="center"><?php echo $fetch['username']?>
                   <td ><a href="userview2.php?b=<?php echo $fetch['username'];?>">
                       <font color="orange"><b style="font-size:27px;">view</b></font></a></td></tr>
