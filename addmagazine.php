            ...
            <div class="row">
              ...
              <div class="col-lg-6 space-break">
                <div class="contact-form">
                    <form  method="post" action="magazine_action.php" enctype="multipart/form-data" >
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Magazine Name</label>   
                                         <input id="magazine" type="varchar" name="magazine"  class="form-control customize" required/>
                                        <p id="p2"></p>
                 <script>
