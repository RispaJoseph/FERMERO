...
$sq3="select * from feedback where status='2' ";
				...
				<table class="table table-striped" align="center">
					<thead>
						<tr>
                            ...
                            <th  style="color:rgb(181,230,29);"   ><h5><i>OVERALL EXPERIENCE</i></h5></th>
                            <th  style="color:rgb(181,230,29);"   ><h5><i>TIMELY RESPONSE</i></h5></th>
                            <th  style="color:rgb(181,230,29);"   ><h5><i>OUR SUPPORT</i></h5></th>
                            <th  style="color:rgb(181,230,29);"   ><h5><i>OVERALL SATISFACTION</i></h5></th>
						...
						while($fetch=mysqli_fetch_array($exe))
						{
							?>
						        <tr>
                                    ...
                                    <td><?php echo $fetch['review']?></td>
                                    <td><?php echo $fetch['response']?></td>
                                    <td><?php echo $fetch['support']?></td>
                                    <td><?php echo $fetch['satis']?></td>                                    
