...
$sq5="select username from login where status='2' ";
$me8=mysqli_query($con,$sq5);

$sq="select place_name from place ";
$me5=mysqli_query($con,$sq);
mysqli_close($con);
?>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="contact-box">
                  <div class="section-title">
                    <h2>User<span></span>  Registration</h2>
              ...
              <div class="col-lg-6 space-break">
                <div class="contact-form">
                    <form  method="post"  action="action_useregg.php" autocomplete="off" >
