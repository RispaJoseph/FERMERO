...
<body>
        ...
        ?>
                              <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="feedback" name="feedback" class="form-control customize"  rows="6"  data-error="Please,leave us a message." required/></textarea>
                                        <p id="p1"></p>
                 <script>
 ...
 <input type="radio"  name="review" value="very good" required> Very Good &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input type="radio" name="review" value="good"> Good
 ...
 <input type="radio"  name="response" value="very good" required> Very Good &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input type="radio" name="response" value="good"> Good
 ...
 <input type="radio"  name="support" value="very good" required> Very Good &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input type="radio" name="support" value="good"> Good
 ...
 <input type="radio"  name="satis" value="very good" required> Very Good &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input type="radio" name="satis" value="good"> Good
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <textarea id="feed" name="feed" class="form-control customize"  rows="6"  data-error="Please,leave us a message." required/></textarea>
                                        <p id="p1"></p>
                 <script>
