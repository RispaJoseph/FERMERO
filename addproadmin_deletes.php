...
$sql1="update  addproadmin set status='9' where pid='$uid'";
$exe1=mysqli_query($con,$sql1);
    header("location:viewdisabledadminproducts.php");
}
$sql="select * from addproadmin where pid='$uid'";
              ...
              <div class="col-lg-6">
                <div class="contact-box">
                  <div class="section-title">
                    <h2>Disable<span>  Products </span></h2>
...
<tr>  
       ...
       <td><input type="text"  class="form-control" name="category_name" value="<?php echo $new2['category_name']?>"></td></tr>
