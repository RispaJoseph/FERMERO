...
$sql="select * from subsidy where comp='$uid'";
...
<center><h1 style="color:rgb(181,230,29);"><i><b> </b></i></h1></center>
		...
		<div class="messages"></div>
          ...
          <tr>  
              <td> <label style="color:green;size=20px;" ><b>Scheme</b></label></td>
       <td><input type="text"  class="form-control" name="title" value="<?php echo $new2['title']?>"></td></tr>
             <tr>
                            <tr><td> <label style="color:green;">Component</label></td><td><input type="text"  class="form-control" name="comp" value="<?php echo $new2['comp']?>"></td></tr>
                            <tr><td> <label style="color:green;">Unit </label></td><td><input type="text"  class="form-control" name="Unit" value="<?php echo $new2['unit']?>"></td></tr>
                          <tr> <td> <label style="color:green;">Subsidy Amount</label></td> <td> <input type="text"  class="form-control" name="amount" value="<?php echo $new2['amount']?>"></td></tr>
                             <tr> <td> <label style="color:green;">Subsidy %</label></td> <td> <input type="text"  class="form-control" name="percentage" value="<?php echo $new2['percentage']?>"></td></tr>
