...
include('session.php'); 
              ...
              {
                $m=$_POST['category1'];
$sq3="select * from dir where  category1='$m'";
$exe=mysqli_query($con,$sq3)or die( mysqli_error($con));
...
<body>
              ...
              <div class="col-lg-6">
                <div class="contact-box">
                  <div class="section-title">
                    <h2>View<span>Directory</span></h2>
 ...
 <p><select id="category1" type="dropdown" class="form-control customize"   onChange="getCity7(this.value);" name="category1" required>
...
<footer>
        <div class="container">
            <div class="row">
				...
				<table  id=s3 class="table table-striped" border="1" >
					<thead>
						<tr>
                            
                            <th class="col-xs-12"  style="color:rgb(181,230,29);"   ><h5><i></i></h5></th>
