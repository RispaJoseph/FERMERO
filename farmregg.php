...
$sq6="select username from farmer where status='0' ";
$me8=mysqli_query($con,$sq6);

$sq5="select place_name from place  ";
                    ...
                    <ul class="navbar-nav ml-auto">
                      <li class="nav-item dropdown">
                       <!-- <a class="nav-link  dropdown-toggle" href="#" data-toggle="dropdown">HOME<span class="caret-drop"></span></a>
                        ...
                        <ul class="dropdown-menu">
                          <li class="divider-top"></li>
                          <li><a class="dropdown-item" href="farmregg.php">Farmer</a></li>
                          <li class="divider"></li>
                          <li><a class="dropdown-item" href="suppreg.php">Supplier</a></li>
                          <li class="divider"></li>
                          <li><a class="dropdown-item" href="useregg.php">User</a></li>
                        </ul>
                      </li>                 
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="contact-box">
                  <div class="section-title">
                    <h2>Farmer<span></span>  Registration</h2>
              ...
              <div class="col-lg-6 space-break">
                <div class="contact-form">
                    <form  method="post"  action="action_reg.php" enctype="multipart/form-data" >
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input id="tname" type="text" name="name"  class="form-control customize"  required/> 
                                        <p id="p0"></p>
                 <script>
       ...
       $('#p0').text("* please enter a valid  name *"); 
         $('#tname').focus(); 
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Photo</label>
                                        <input id="photo" type="file" name="photo"  accept="image/*" onchange="ValidateImage()"  class="form-control customize" required/>
...
function ValidateImage() {
 ...
 <p><select id="place" type="dropdown"  class="form-control customize" name="place" required>
                     <option value="">--place--</option>
                        <?php
    while($fetch=mysqli_fetch_array($me5))
						{
                            ?>
               <option value="<?php echo $fetch['place_name']?>"><?php echo $fetch['place_name']?>  <?php
                        }
?></option>
       ...
       $('#p8').text("*  Please enter valid email  *");
        $("#email").focus();
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Adhar</label>
                                        <input id="adhar" type="file" name="adhar"  accept="image/*" onchange="validateImage()" class="form-control customize" required/>
                                         <script type="text/javascript">
function validateImage() {
    var formData = new FormData();
 
    var file = document.getElementById("adhar").files[0];
