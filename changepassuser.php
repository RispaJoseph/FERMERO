...
if(isset($_POST['submit']))
{
    ...
    if(mysqli_query($con,$mql))
    {
         ...
         echo "<script>";
        echo("location.href='changepassuser.php'");
        echo"</script>";
    }
}
...
<form  method="post" action=""  >
         ...
         while($fe=mysqli_fetch_array($mov))
                        ...
                        ?>
                            <input id="name11" type="password" class="form-control customize"  name="memname1" onChange="getCity3334(this.value);"  required>
       <p id="p101"></p>
                 <script src="jquery-3.2.1.min.js" type="text/javascript"></script>     
           <script>
function getCity3334(val) {
	$.ajax({
	type: "POST",
	url: "getCity3334.php",
	data:'state_id='+val,
