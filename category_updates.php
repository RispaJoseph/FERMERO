...
$sql1="update category set category_name='$a'  where category_id='$uid'";
                ...
                <nav class="navbar navbar-expand-lg">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="category.php">ADD PRODUCT</a>
                      </li> 
                            
                                            
<li class="nav-item">
                        <a class="nav-link" href="admin_chat.php">CHAT</a>
                      </li> 
