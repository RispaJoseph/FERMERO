...
$c=$_POST['to'];
$d=$_POST['total_rent'];
$sql1="UPDATE `agri3`.`rent` SET `total_rent` = '$d',`machine_name`='$a',`date2` ='$b',`to`='$c'  WHERE `rent`.`rid` = '$uid'";
              ...
              <div class="col-lg-6">
                <div class="contact-box">
                  <div class="section-title">
                    <h2>Edit<span>  Rent Machines </span></h2>
...
<center><h1 style="color:rgb(181,230,29);"><i><b> </b></i></h1></center>
       ...
       <td><input type="text"  class="form-control" name="machine_name" value="<?php echo $new2['machine_name']?>"></td></tr>
         ...
         <tr> 
             <td> <label>From Date</label></td><td><input type="date"  class="form-control" name="date2" value="<?php echo $new2['date2']?>"></td>
                            <tr><td> <label>To</label></td><td><input type="date"  class="form-control" name="to" value="<?php echo $new2['to']?>"></td></tr>
                           
                        
                            
                        
                            <tr><td> <label>Total_rent</label></td><td><input type="number"  class="form-control" name="total_rent" value="<?php echo $new2['total_rent']?>"></td></tr>
		...
		<td><input type="submit" name="submit"  class="btn btn-custom" value="Update"></td>
