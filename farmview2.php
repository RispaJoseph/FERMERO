...
<tr>  
       ...
       <td><input type="text"  class="form-control" name="email" value="<?php echo $fetch['email']?>"></td></tr>
                        ...
                        <tr><td><a  style="padding:5px;width:25%;font-size:20px;font-family:cooper black;color:orange" href="block.php?m=<?php echo $fetch['reg_id'];?>"><font style="font-size:35px;" ><b>&nbsp;Block</b></font></a></td></tr>
