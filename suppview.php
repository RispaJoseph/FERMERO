				...
				<table class="table table-striped" align="center">
                    <thead>
						...
						<th style="font-size:20px;color:darkorange"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NAME</b></th>
                            <th style="font-size:15px;color:orange"><a href="./pdf/suppdown.php" class="btn btn-custom">&nbsp;&nbsp;&nbsp;DOWNLOAD<span  class="glyphicon glyphicon-download-alt"></span></a></th>
                   ...
                   <td ><a href="suppview2.php?b=<?php echo $fetch['username'];?>">
