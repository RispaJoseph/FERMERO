                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="name" type="text" name="category_name" class="form-control customize"  required="required" >
                                        <p id="p0"></p>
                 <script>
    ...
    if ( $(this).val().match('^[a-zA-Z]{3,25}$') ) {
       ...
       $('#p0').text("* please enter a valid  name *"); 
         $('#name').focus(); 
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p><input type="submit" class="btn btn-custom" name="submit" value="Add Category"></p>
                                </div>
                            </div>
                        </div>
                    </form>  
