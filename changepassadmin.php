...
if(isset($_POST['submit']))
{
    ...
    if(mysqli_query($con,$mql))
    {
         ...
         echo "<script>";
        echo("location.href='changepassadmin.php'");
        echo"</script>";
    }
}
...
<form  method="post" action=""  >
         ...
         while($fe=mysqli_fetch_array($mov))
                        ...
                        ?>
                            <input id="name11" type="password" class="form-control customize"  name="memname1" onChange="getCity3333(this.value);"  required>
       <p id="p101"></p>
                 <script src="jquery-3.2.1.min.js" type="text/javascript"></script>     
           <script>
function getCity3333(val) {
	$.ajax({
	type: "POST",
	url: "getCity3333.php",
	data:'state_id='+val,
                               ...
                               while($fetch=mysqli_fetch_array($res))
                               {
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input id="tname" type="text" name="name"  value="<?php echo $fetch['name']?>" class="form-control customize"  required/> 
                                        <p id="p0"></p>
                 <script>
       ...
       $('#p0').text("* please enter a valid  name *"); 
         $('#tname').focus(); 
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Age</label>
                                        <input id="age" type="number" name="age" value="<?php echo $fetch['age']?>" class="form-control customize"  data-error="required" required/>
                                         <p id="p5"></p>
                 <script>
       ...
       $('#p1').text("* please enter a valid value*");
        $("#hname").focus();
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Place</label>
                                        <p><select id="place" type="dropdown" value="<?php echo $fetch['place']?>" class="form-control customize" name="place" required>
                     <option value="">--place--</option>
                        <?php
    while($fetch2=mysqli_fetch_array($place))
						{
                            ?>
               <option value="<?php echo $fetch['place_name']?>"><?php echo $fetch2['place_name']?>  <?php
                        }
?></option>
