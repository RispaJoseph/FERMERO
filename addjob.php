...
<body>
 ...
 <p><select id="category1" type="dropdown"  class="form-control customize" name="category1" required>
     ...
     <option value="Outdoor Farming">Outdoor Farming</option>
...
<label class="errormob" style="display:none; color:black" id="mobile_1"></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Salary</label>
                                        <input id="salary" type="number" name="salary" onKeyUp="multiply()"  class="form-control customize"  required/>
    ...
    if ( $(this).val() >= 5 && $(this).val() <= 50000 ) {
       ...
       $('#p55').text("* enter a valid value *");
        $("#salary").focus();
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p><input type="submit" class="btn btn-custom" name="submit" value="Add Job"></p>
                                </div>
                            </div>
                        </div>
                    </form>  
