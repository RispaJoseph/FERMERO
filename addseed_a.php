...
$sq3="select * from addprosupp where status='1'";
...
<body>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 space-break">
                <div class="contact-form">
                    <form  method="post" action="seed_action.php"  enctype="multipart/form-data" >
 ...
 <p><select id="category_id" type="dropdown" class="form-control customize"  onChange="getCity2(this.value);"  name="category_name" required>
       ...
       $('#p0').text("* please enter a valid  name *"); 
         $('#des').focus(); 
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Amount</label>
                                        <input id="amount" type="varchar" name="amount"  onKeyUp="multiply()" class="form-control customize" required/>
                                          <p id="p1"></p>
                 <script>
         ...
         $('#amount').focus(); 
                                  ...
                                  <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select id="quantity" type="dropdown" name="quantity"   class="form-control customize" required>
         ...
         $('#unitcost').focus(); 
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="tprice" type="number" name="tprice" class="form-control customize"  required="required" data-error=" required" required readonly>
                                        <p id="p10"></p>
                 <script>
...
<td><a  style="padding:5px;width:25%;font-size:20px;font-family:cooper black;color:orange" href="seed_updates.php?m=<?php echo $fetch['pid'];?>"><font ><b>Edit</b></font></a></td>
                                                                          
<td><a  style="padding:5px;width:25%;font-size:20px;font-family:cooper black;color:orange" href="seed_delete.php?m=<?php echo $fetch['pid'];?>"><font ><b>Disable</b></font></a></td>                                  
