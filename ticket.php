...
$sql5="INSERT INTO `agri3`.`ticket` (`id`,`reg_id`,`name`, `phone`,`title`,`price`,`quantity`,`tprice`,`status` ) VALUES (NULL,'$user', '$a', '$c','$d','$e','$f','$g','unpaid');";
$exe5=mysqli_query($con,$sql5);
    ...
    header("location:ticketpayement.php?".$query);
}
?>
              ...
              <div class="col-lg-6">
                <div class="contact-box">
                  <div class="section-title">
                    <h2>Booking<span></span>  Details</h2>
...
<label class="errormob" style="display:none; color:black" id="mobile_1"></label>
                               ...
                               while($fetch1=mysqli_fetch_array($res1))
                               {
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label> Event</label>
                                        <input id="title" type="text" name="title"  value="<?php echo $fetch1['title']?>" class="form-control customize"  readonly  required/> 
                                ...
                                ?>
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Price</label>
                                        <input id="price" type="number"  value="30" name="price"  onKeyUp="multiply()"  class="form-control customize"  readonly/>
                                 ...
                                 <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="quantity" type="number" name="quantity"  onKeyUp="multiply()"  class="form-control customize" required/>
                                           <p id="p1"></p>
                 <script>
