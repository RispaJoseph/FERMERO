...
$uid=$_GET['m'];
 ...
 $sql1="select * from subsidy where title='$uid'";
$res=mysqli_query($con,$sql1);

$sq3="select * from feedback where status='0' ";
            ...
            <div class="row">
				...
				<div class="outer-w3-agile mt-3">
                   <div class="container">
                        <table class="table">
					<thead>
						<tr><th   ><h6 style="color:green;width:50%"><i>SUBCOMPONENT</i></h6></th>
						
						<th class="text-left" ><h6 style="color:green;"><i> CATEGORY</i></h6></th>
						
<th   class="text-left" style="color:rgb(181,230,29);width:5%"   ><h6 style="color:green;"><i>UNIT</i></h6></th>
<th    class="text-left" style="color:rgb(181,230,29);width:15%;"><h6 style="color:green;"><i>AMOUNT</i></h6></th>

                            <th class="text-left" ><h6 style="color:green;"><i> PERCENTAGE</i></h6></th>
                           
                             <th class="text-left" ><h6 style="color:green;"><i> ACTION</i></h6></th>
...
<td><a href="subsidy_s.php?m=<?php echo $fetch['comp'];?>"><font color="Orange"><b>View</b></font></a></td>
