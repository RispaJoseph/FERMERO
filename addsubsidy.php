...
<body>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 space-break">
                <div class="contact-form">
                    <form  method="POST" action="subsidy_action.php" enctype="multipart/form-data">
 ...
 <p><select id="category_name" type="dropdown"  class="form-control customize" name="category_name" required>
                    <option value="">--Category--</option> 
                      <option value=" Establishment of new garden area plantation">Establishment of new garden area plantation</option>  
     <option value="Technical Group Support">Technical Group Support</option> 
     <option value="Plantation Infrastructure Development Production">Plantation Infrastructure Development Production</option> 
    ...
    if ( $(this).val().match('^[a-zA-Z ]{3,1000}$') ) {
       ...
       $('#p0').text("* please enter a valid  description *"); 
         $('#des').focus(); 
                                    ...
                                    <div class="form-group">
                                        <label>Unit</label>   
                                         <input id="unit" type="varchar" name="unit"  class="form-control customize" required/>
                                        <p id="p32"></p>
                 <script>
        ...
        $("#unit").focus();
                                    ...
                                    <div class="form-group">
                                        <label>Sub Component</label>   
                                         <input id="comp" type="varchar" name="comp"  class="form-control customize" required/>
                                        <p id="p233"></p>
                 <script>
       ...
       $('#p233').text("* please enter a valid place *");
        $("#comp").focus();
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="amount" type="number" name="amount"   class="form-control customize"  required/>
                                          
                                          <p id="p55"></p>
                 <script>
                 $("#amount").on("blur", function() {
                    
    if ( $(this).val() >= 1 && $(this).val() <= 100000000 ) {
       $('#p55').hide();
    } else {
         $('#p55').show();
        ...
        $("#amount").focus();
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="percentage" type="number" name="percentage" onKeyUp="multiply()"  class="form-control customize"  required/>
    ...
    if ( $(this).val() >= 1 && $(this).val() <= 100 ) {
       ...
       $('#p55').text("* enter a valid value *");
        $("#percentage").focus();
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p><input type="submit" class="btn btn-custom" name="submit" value="Add Subsidy"></p>
                                </div>
                            </div>
                        </div>
                    </form>  
