...
$sq3="select * from place where status='2'";//select active list of country
...
$a=$_POST['name'];
     ...
     $f=$_POST['phone'];
     $g=$_POST['email'];
 $sql89="update reg set name='$a' ,age='$c',house_name='$d',phone='$f',email='$g' where username='$user'";
    if(mysqli_query($con,$sql89))
    {
          echo "<script>";echo "alert('Successfully updated!')";echo"</script>";
         echo "<script>";
        echo("location.href='editprofileuser.php'");
        echo"</script>";
    }
}
?>
