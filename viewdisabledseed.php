...
$sq3="select * from addprosupp where status='8'";
...
<td><a  style="padding:5px;width:25%;font-size:20px;font-family:cooper black;color:orange" href="seed_enable.php?m=<?php echo $fetch['pid'];?>"><font ><b>Enable</b></font></a></td>
