...
{
header("location:viewfarmerspassword.php");
}
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                     <!-- <li class="nav-item dropdown">
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="./web/adminhome.php">HOME</a>
                      </li>
                      
                                              
                          <li class="nav-item">
                        <a class="nav-link" href="addproduct_f.php">ADD PRODUCT</a>
    ...
    <div class="sections gallery-background">
        <div class="container">
            <div class="pages-title">
                <h1>VIEW <br> <span>PROFILE</span></h1>
				...
				<table class="table table-striped" >
					<thead>
						<tr>
                                  ...
                                  <th  style="color:rgb(181,230,29);width:4%"   ><h5><i>PASSWORD</i></h5></th>
                                
                            <th  style="color:rgb(181,230,29);width:4%"   ><h5><i>EDIT</i></h5></th>
						...
						while($fetch=mysqli_fetch_array($exe))
						{
							?>
						        <tr>
                                    ...
                                    <td style="text-align:right;"><a  style="padding:5px;width:25%;font-size:20px;font-family:cooper black;color:orange"  href="farmerspassword_upadates.php?m=<?php echo $fetch['reg_id'];?>"><font ><b>edit</b></font></a></td>
