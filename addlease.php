            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="contact-box">
                  <div class="section-title">
                    <h2>Add<span>Land Details</span></h2>
              ...
              <div class="col-lg-6 space-break">
                <div class="contact-form">
                    <form  method="POST" action="lease_action.php" enctype="multipart/form-data">
       ...
       $('#p32').text("* please enter a valid title *");
        $("#title").focus();
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Service</label>   
                                         <input id="service" type="service" name="service" value="Land for Lease"  class="form-control customize" required/>
...
<label class="errormob" style="display:none; color:black" id="mobile_1"></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Price</label>
                                        <input id="price" type="number" name="price" onKeyUp="multiply()"  class="form-control customize"  required/>
                                          
                                          <p id="p55"></p>
                 <script>
                 $("#price").on("blur", function() {
                    
    if ( $(this).val() >= 5 && $(this).val() <= 50000 ) {
       $('#p55').hide();
    } else {
         $('#p55').show();
       $('#p55').text("* enter a valid value *");
        $("#price").focus();
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p><input type="submit" class="btn btn-custom" name="submit" value="Add Land"></p>
                                </div>
                            </div>
                        </div>
                    </form>  
