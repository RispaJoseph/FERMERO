            ...
            <div class="row">
              ...
              <div class="col-lg-6 space-break">
                <div class="contact-form">
                    <form  method="POST" action="agripedia_action.php" enctype="multipart/form-data">
         ...
         $('#des').focus(); 
                                    ...
                                    <div class="form-group">
                                        <label> Second Image</label>   
                                         <input id="image1" type="file" name="image1" accept="image/*"  class="form-control customize"  onchange="validateImage()" required/>
                                        <script type="text/javascript">
function validateImage() {
    var formData = new FormData();
    ...
    return true;
                                    ...
                                    <div class="form-group">
                                        <label> Third Image</label>   
                                         <input id="image2" type="file" name="image2" accept="image/*"  class="form-control customize"  onchange="validateImage()" required/>
                                        <script type="text/javascript">
function validateImage() {
    var formData = new FormData();
    ...
    return true;
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="des1" name="des1" class="form-control customize"  ></textarea>
                                        <p id="p0"></p>
                 <script>
                 $("#des1").on("blur", function() {
    if ( $(this).val().match('^[a-zA-Z ]{3,1000}$') ) {
       $('#p00').hide();
    } else {
         $('#p00').show();
       $('#p00').text("* please enter a valid  description *"); 
         $('#des').focus(); 
    }
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p><input type="submit" class="btn btn-custom" name="submit" value="Add "></p>
                                </div>
                            </div>
                        </div>
                    </form>  
