...
function loginForm() {
	...
	<div class="form-group">
		<div id="loginform">
			...
			<h1 style="color:green;"> Live Chat</h1><hr/>
				<label  for="name" style="color:blue;">Please Enter Your Name To Proceed..</label>
				<input type="text" name="name" id="name" class="form-control" placeholder="Enter Your Name"/>
                <br>
				<input type="submit" class="btn btn-success" name="enter" id="enter" value="Enter" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               
				<input type="submit" class="btn btn-success" name="Home" id="Home" value="Home" />			
			</form>
		</div>
	</div>
   ';
...
<div id="wrapper">
	...
	<h1 style="color:green;"> Live Chat!</h1><hr/>
		...
		<p class="logout"><a id="exit" href="#" class="btn btn-success">Exit Live Chat</a></p>
