...
$s=header("location:https://www.fast2sms.com/dev/bulk?authorization=TsZKQXP9nf5c6JUqYaotmRO1Vg3LiNerB4WxMzvwu0hCpbdAy7kwfZcTNBS5Lbxt7Jmyh4dG3Ponj6u2&sender_id=FSTSMS&language=english&route=qt&numbers=7907763591&message=26326&variables={AA}|{CC}&variables_values=12345|asdaswdx");
                ...
                <nav class="navbar navbar-expand-lg">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                   <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="./warsaw/success_view.php">SUCCESSFULL STORIES</a>
                      </li>
                        <li class="nav-item">
                        <a class="nav-link" href="./warsaw/agripedia_view.php">AGRIPEDIA</a>
                      </li>
        ...
        $("#email").focus();
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="mode" type="text" name="mode"  value="Cash On Delivery" class="form-control customize"  readonly  required/> 
 ...
 function Validate() {
        ...
        return true;
						...
						<div class="contact100-form-checkbox">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p><input type="submit" class="btn btn-custom" name="submit"  onclick="return validate()" value="Complete Order"></p>
                                </div>
                            </div>
                        </div>
                    </form>  
